...
query_name_dict = {
                   (('e', ('r','r')), ('e', ('r','n'))): 'base-SC1-1order',
                   ((('e', ('r','r')), ('e', ('r','r'))),(('e', ('r','n')), ('e', ('r','n')))): 'base-SC1-2order',
...
def parse_args(args=None):
    ...
    parser.add_argument('--data_path', type=str, default="data/HGA/3-order", help="KG data path")
    parser.add_argument('-n', '--negative_sample_size', default=1, type=int, help="negative entities sampled per query")
    parser.add_argument('-d', '--hidden_dim', default=128, type=int, help="embedding dimension")
    ...
    parser.add_argument('--max_steps', default=26000, type=int, help="maximum iterations to train")
    parser.add_argument('--warm_up_steps', default=None, type=int,
                        help="no need to set manually, will configure automatically")

    parser.add_argument('--save_checkpoint_steps', default=26000, type=int, help="save checkpoints every xx steps")
    ...
    parser.add_argument('--tasks', default='base-1order.base-2order.base-3order.base-SC1-1order.base-SC1-2order.base-SC1-3order', type=str,
...
def main(args):
    ...
    args.checkpoint_path = "logs/data_HGA/g-60.0-d-128-mode-[1600,2]/3-order/checkpoint90000"
    if args.checkpoint_path is not None:
        ...
        checkpoint = torch.load("logs/data_HGA/g-60.0-d-128-mode-[1600,2]/3-order/checkpoint90000")
