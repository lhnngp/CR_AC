...
class TestDataset(Dataset):
    def __init__(self, queries, nentity, nrelation, answer):
    ...
    def __getitem__(self, idx):
        ...
        return positive_sample,negative_sample, subsampling_weight,flatten(query), query, query_structure
    ...
    def collate_fn(data):
        ...
        query_unflatten = [_[4] for _ in data]
        query_structure = [_[5] for _ in data]
        return positive_sample,negative_sample,subsample_weight, query, query_unflatten, query_structure
